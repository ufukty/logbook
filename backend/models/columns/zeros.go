...
const (
	ZeroAreaId            = ControlAreaId("00000000-0000-0000-0000-000000000000")
	...
	ZeroCollaboratorId    = CollaboratorId("00000000-0000-0000-0000-000000000000")
	...
	ZeroGroupMembershipId = GroupMembershipId("00000000-0000-0000-0000-000000000000")
